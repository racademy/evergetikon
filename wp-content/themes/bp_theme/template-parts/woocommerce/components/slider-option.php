...
$link = get_field('section_link', 'option');
$product_source = get_field('product_source', 'option');
$manual_products = get_field('manual_products', 'option');
$category_id = get_field('product_category', 'option');
